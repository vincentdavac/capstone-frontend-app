        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center md:flex-row">
            <div className="z-10 mb-10 md:mb-0 md:w-1/2">
              ...
              <p className="mb-8 max-w-lg text-lg text-gray-700 md:text-xl">
            ...
            <div className="relative md:w-1/2">
              <div className="relative h-[300px] overflow-hidden rounded-lg shadow-xl md:h-[400px]">
                ...
                <button
                  onClick={prevSlide}
                  className="absolute top-1/2 left-2 -translate-y-1/2 rounded-full bg-white/70 p-2 text-[#386742] hover:bg-white"
                ...
                <button
                  onClick={nextSlide}
                  className="absolute top-1/2 right-2 -translate-y-1/2 rounded-full bg-white/70 p-2 text-[#386742] hover:bg-white"
                ...
                <div className="absolute right-0 bottom-4 left-0 flex justify-center space-x-2">
                  {slides.map((_, index) => (
                    <button
                      ...
                      className={`h-3 w-3 rounded-full ${index === currentSlide ? "bg-[#386742]" : "bg-white/50"}`}
